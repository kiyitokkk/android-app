...
public final class FragmentMessagesBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout messagemain;

  private FragmentMessagesBinding(@NonNull FrameLayout rootView, @NonNull FrameLayout messagemain) {
  ...
  public static FragmentMessagesBinding bind(@NonNull View rootView) {
    ...
    FrameLayout messagemain = (FrameLayout) rootView;

    return new FragmentMessagesBinding((FrameLayout) rootView, messagemain);
  }
}
