...
public final class CustomDialogBinding implements ViewBinding {
  ...
  private CustomDialogBinding(@NonNull LinearLayout rootView, @NonNull TextView commentsTextView,
  ...
  public static CustomDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomDialogBinding((LinearLayout) rootView, commentsTextView, publishButton);
    }
